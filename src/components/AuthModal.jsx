...
function AuthModal({ isOpen, isRegister = false, onClose, onLogin }) {
    ...
    return createPortal(
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[99999] animate-[fadeIn_0.2s_ease-out] modal-overlay modal-backdrop cursor-pointer" onClick={onClose}>
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden relative m-4 cursor-default" onClick={e => e.stopPropagation()}>
                <button
                    onClick={onClose}
