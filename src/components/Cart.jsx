...
function Cart({ isOpen, onClose, onCartUpdate, onCheckout }) {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 z-[99999] flex items-center justify-center p-4 modal-overlay modal-backdrop cart-modal" style={{ isolation: 'isolate' }}>
